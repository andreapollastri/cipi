...
<h2>I'm working to solve all issues bugs and to a new Vue based frontend! Sorry for the late! I'm Working for you In the meanwhile I'll solve all open issues for current version... give some week to deploy a big patch!!!</h2>
