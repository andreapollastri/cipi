...
echo "Downloading last version of Cipi Control Panel from packagist.org... It may takes some time! Hold on :)"
sleep 1s
...
echo "After login, you can update credentials into 'settings area'"
echo ""
